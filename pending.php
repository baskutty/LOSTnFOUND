...
<tr align="center" >
  ...
  <th style="text-align: center;line-height: 25px;">Approve Blog</th>
...
$get_mov="select * from blog where status='0' order by refNo desc";
$run_mov=mysqli_query($con,$get_mov);
$i=1;
while($row_mov=mysqli_fetch_array($run_mov))
{
$blog_id=$row_mov['refNo'];
$spamc=$row_mov['spamCount'];
$viewc=$row_mov['viewCount'];
$userid=$row_mov['ownerID'];
$text=$row_mov['text'];
    $timestamp=$row_mov['timeStamp'];
$line=explode("\n", $text);
$name=$line['0'];
...
<td><a href='admin_view.php?blog_id=$blog_id'>view</a></td>
  ...
  <td><a href='spam_delete.php?blog_id=$blog_id' onClick=\"javascript:return confirm('are you sure you want to delete this?');\">delete</a></td>
  <td><a href='approve.php?blog_id=$blog_id' onClick=\"javascript:return confirm('are you sure you want to approve this?');\">approve</a></td></tr>";
