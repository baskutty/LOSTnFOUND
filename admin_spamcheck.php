...
<tr align="center" >
  ...
  <th style="text-align: center;line-height: 25px;">Spam report percentage</th>
...
$get_mov="select * from blog where status='1'";
...
if($viewc!=0)
{
$rat=number_format((float)$spamc/$viewc, 2, '.', '');
$perc=$rat*100;
if($perc>=75 && $viewc>=20)
{
...
<td><a href='admin_view.php?blog_id=$blog_id'>view</a></td>
  ...
  <td><a href='spam_delete.php?blog_id=$blog_id' onClick=\"javascript:return confirm('are you sure you want to delete this?');\">delete</a></td></tr>";
