...
<tr>
      ...
      <td><input type="text" name="blog_title" size="30" maxlength="20" placeholder=" Enter maximum of 20 char "required></td>
    </tr>
...
$insert_blog="insert into blog(timeStamp,spamCount,viewCount,text,ownerID,status) values ('$timestamp','0','0','$text','$userid','1')";
