  ...
  <nav class="navbar navbar-inverse navbar-fixed-top">
      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
           <form method="get" action="admin_results.php" enctype="multipart/form-data" class="navbar-form navbar-right search">
...
$user_id=$row_the['userID'];
 ...
 <div class="container-fluid">
  ...
  <div>
<table  style="background-color:#F0F8FF; margin-left: 300px; " align="center" width="1000"  border="5" >
...
$i=1;
  ...
  $blog="select * from blog where ownerID='$user_id' and status='1' order by refNo desc";
